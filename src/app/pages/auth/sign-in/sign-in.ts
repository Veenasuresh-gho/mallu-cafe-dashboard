    ...
    this.srv.getdata('teammember', this.tv).subscribe({
      next: (r) => {
        ...
        if (r.Status === 1) {
          ...
          // Store only permissions in localStorage
          const permissions = {
            MediaUploadPermission: u.MediaUploadPermission,
            AdManagementPermission: u.AdManagementPermission,
            ProgramManagementPermission: u.ProgramManagementPermission,
            MemberManagementPermission: u.MemberManagementPermission
          };
