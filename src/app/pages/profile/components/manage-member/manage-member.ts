...
@Component({
  ...
  imports: [MatDialogContent, MatDialogActions, FormsModule, CommonModule,
      MatChipsModule,DialogHeaderComponent, StepBadge, FormInput, FormSelect, FormMultiSelect, PrimaryButton],
